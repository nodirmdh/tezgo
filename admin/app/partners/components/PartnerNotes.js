...
export default function PartnerNotes({
  ...
  return (
    <section className="card profile-card">
      <div className="profile-title">{t("partners.notes.title")}</div>
      ...
      >
        <div className="auth-field">
          <label htmlFor="noteText">{t("partners.notes.note")}</label>
          <textarea
            id="noteText"
            className="input"
            rows={3}
            ...
            placeholder={t("partners.notes.placeholder")}
          />
        </div>
              ...
              <li key={note.id} className="log-item">
                <div>
                  <div className="log-title">
                    {note.author_username || note.author_tg_id || t("partners.notes.support")}
                  </div>
