...
export default function OutletNotes({
  ...
  return (
    <section className="card profile-card">
      <div className="profile-title">{t("outlets.notes.title")}</div>
      ...
      >
        <div className="auth-field">
          <label htmlFor="noteText">{t("outlets.notes.note")}</label>
          <textarea
            id="noteText"
            className="input"
            rows={3}
            ...
            placeholder={t("outlets.notes.placeholder")}
          />
        </div>
              ...
              <li key={note.id} className="log-item">
                <div>
                  <div className="log-title">
                    {note.author_username || note.author_tg_id || t("outlets.notes.support")}
                  </div>
